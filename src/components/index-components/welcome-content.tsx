  ...
  return (
    <article className="grid lg:grid-cols-2 w-full content-center h-[90%]">
      ...
      <div className="relative p-[20px] lg:p-0">
        ...
        {/*ADD OUTLINE*/}
        <h1 className="absolute text-stroke-white opacity-20 lg:left-[10px] left-[25px] lg:top-[38px] font-integralCF text-white lg:text-[76px] text-[52px] leading-[98%]">
          SMART <br /> BUSINESS <br /> SOLUTIONS
        </h1>
        <h1 className="relative z-10 font-integralCF text-white lg:text-[76px] text-[52px] leading-[98%]">
          SMART <br /> BUSINESS <br /> SOLUTIONS
        </h1>
