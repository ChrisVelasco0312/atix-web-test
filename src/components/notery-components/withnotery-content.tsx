  ...
  return (
    <article className="h-[316px] grid content-center justify-items-center">
      <h1 className="text-white lg:text-[24px] text-[16px] text-center lg:w-[900px]">
        ...
        <strong className="lg:text-[24px] text-[20px] lg:inline block">your document management assistant,</strong> which data it needs to collect  from your documents</h1>
    </article>
  );
};
