...
const Stepper = ({ steps }: { steps: Step[] }) => {
  return (
    <div className="relative text-white grid gap-8">
      ...
      {steps.map((step) => (
        <div key={step.id} className="flex items-start gap-4 relative z-2">
...
const HowitworksContent = () => {
  const steps: Step[] = [
    ...
    {
      id: 4,
      info: <p className="w-[380px]">Generate reports effortlessly, with the flexibility to personalize data in various formats.</p>
    }
  ];
