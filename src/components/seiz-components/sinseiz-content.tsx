const SinseizContent = () => {
  return (
    <article
      className="relative lg:h-[870px] h-[583px] lg:p-0 p-8 overflow-hidden lg:overflow-visible">
      <div className="lg:absolute left-[100px] top-[76px] lg:h-[870px]">
        <div className="lg:absolute top-[20px] left-[-200px]">
          <h1 className="lg:w-[567px] w-[320px] font-integralCF lg:text-[40px] text-[28px] text-[#0E2B3D] leading-[120%]">
            Wasting valuable
        ...
        <div className="lg:absolute lg:left-[230px] flex lg:w-[1198px] lg:h-[718px]">
          ...
          <img className="lg:absolute relative left-[50px] lg:right-[128px] lg:top-[0px] lg:w-auto w-[393px]" src="../images/sinseiz-graph-2.png" alt="graph-2" />
